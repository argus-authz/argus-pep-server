...
public class DefaultPolicyInfoParser implements PolicyInfoParser {

  public PolicyProfileInfo parse(String policyFileName) {
    ...
    return new PolicyProfileInfoImpl(alias, caSubjects);
  }
