...
public class UpdatingPolicyNamesCache {
  ...
  private static final Logger LOG = LoggerFactory
    .getLogger(UpdatingPolicyNamesCache.class);
  ...
  /**
   * time interval (in msec) after which info files cache will be refreshed,
   ...
   * 
   * @param msecs
   *          number of millisecs between updates
   * @see #UPDATEINTERVAL
   */
   ...
   *          number of millisecs between updates
   * @throws IOException
   *           on read errors for trust_dir or one of the info files
   * @see #UpdatingPolicyNamesCache(String)
   * @throws IOException
   *           in case of I/O errors
   */
  public UpdatingPolicyNamesCache(String trustDir, long msecs)
    throws IOException {
    this(trustDir);
  ...
  /**
   * constructs new UpdatingPolicyNamesCache based on given trustDir and default
   * {@link #UPDATEINTERVAL}.
   * 
   * @param trustDir
   *          directory containing info files
   * @param updateInterval
   *          interval (msec) between info file cache updates
   ...
   * 
   * @param dn
   *          String subject DN to look for
   * @return array of String with all the matching info files
   * @throws IOException
   *           upon reading errors in updating the {@link PolicyNamesCache}
   ...
   * 
   * @throws IOException
   *           upon I/O errors in updating the {@link PolicyNamesCache}
   */
